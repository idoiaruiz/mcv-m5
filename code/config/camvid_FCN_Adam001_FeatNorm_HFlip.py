...
# Model
model_name                   = 'segnet_vgg'    # Model to use ['fcn8' | 'segnet_vgg' | 'segnet_basic' | 'vgg16' |  'vgg19' | 'resnet50' | 'InceptionV3' | 'densenet']
...
weights_file                 = '/home/master/M5/results/Experiments/camvid/segnetvggtrain/weights.hdf5'  # Training weight file name
