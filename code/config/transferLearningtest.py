...
weights_file                 = '/home/master/M5/results/Experiments/BelgiumTSC/transferlearningBTStrain8-layer19/weights.hdf5'  # Training weight file name
...
n_epochs                     = 8              # Number of epochs during training
