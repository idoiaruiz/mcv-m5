...
dataset_name                 = 'Udacity' # Dataset name TT100K_detection
...
weights_file                 = '/home/master/M5/results/Experiments/Udacity/yolo_train_udacity/weights.hdf5'  # Training weight file name
