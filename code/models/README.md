...
| ------------- | ------------- |----------------------|----------------------|----------------------|
| Baseline| 91.50  |   86.35  |  0.626   |  0.518   |	        
| RMSprop optimizer (lr=0.0001) with Horizontal and Vertical shift (20%) |    91.55     |     86.72     |  0.632   |  0.541   |        
| RMSprop optimizer (lr=0.0001) with Horizontal flip | 92.96 |  87.34   |  0.686   |   0.558  |	        
| RMSprop optimizer (lr=0.0001) with Feature normalization |     91.68     |            85.16     |  0.626   |  0.505   |	        
| RMSprop optimizer (lr=0.0001) with Horizontal flip and feature norm. | 91.79 |   84.46  |   0.646  | 0.498    |
...
[Configuration file: RMSprop opt. (lr=0.0001) with Horizontal and Vertical shift (20%)](../config/camvid_FCN_HorVertShift.py) |
[Configuration file: RMSprop opt. (lr=0.0001) with Horizontal flip](../config/camvid_FCN_horizontal_flip.py) |
[Configuration file: RMSprop opt. (lr=0.0001) with Feature normalization](../config/camvid_FeatureNormalization.py) |
[Configuration file: RMSprop opt. (lr=0.0001) with Horizontal flip and feature norm.](../config/camvid_FCN_FeatureNormalization_HorizontalFlip.py)|
