...
class Configuration():
    ...
    def load_config_dataset(self, dataset_name, dataset_path, shared_dataset_path, problem_type, num_bootstrap, name='config'):
        ...
        bootstrap_data = 'bootstrap_' + str(num_bootstrap)
        dataset_path = os.path.join(dataset_path, problem_type, dataset_name, bootstrap_data)
